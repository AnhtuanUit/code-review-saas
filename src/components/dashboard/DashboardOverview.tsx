  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400">Overview of your code review activity and recent pull requests</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-slate-800/50 border-slate-700 p-6">
          ...
          <h3 className="text-sm font-medium text-slate-300 mb-1">Active PRs</h3>
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6">
          ...
          <h3 className="text-sm font-medium text-slate-300 mb-1">Issues Found</h3>
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6">
          ...
          <h3 className="text-sm font-medium text-slate-300 mb-1">Quality Score</h3>
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6">
          ...
          <h3 className="text-sm font-medium text-slate-300 mb-1">PRs Reviewed</h3>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <div className="p-6 border-b border-slate-700">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Recent Pull Requests</h3>
              <Button 
                variant="ghost" 
                size="sm"
